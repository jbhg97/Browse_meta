...
p1 <- orchard_plot(plant_MR_mod1, mod = "Method", group = "Paper_ID", xlab = "Standardised mean difference (SMD)", legend.pos = "bottom.left")
p2 <- orchard_plot(plant_MR_mod3, mod = "Animal", group = "Paper_ID", xlab = "Standardised mean difference (SMD)", legend.pos = "bottom.left")
...
print(plot2) # need to fix the caption position
```
