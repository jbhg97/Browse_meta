...
p_load(tidyverse, readxl, writexl, kableExtra, orchaRd, clubSandwich, metafor, mice, orchaRd, here, doParallel)
```
...
imp_plant_MMA_mod1 <- mclapply(seq_along(df_imp_plant1), 
                               function(i) MMA(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
...
imp_plant_MR_mod1 <- mclapply(seq_along(df_imp_plant1), 
                              function(i) MR1(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MR_mod1))

imp_plant_MR_mod2 <- list()
imp_plant_MR_mod2 <- mclapply(seq_along(df_imp_plant1), 
                              function(i) MR2(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MR_mod2))

imp_plant_MR_mod3 <- list()
imp_plant_MR_mod3 <- mclapply(seq_along(df_imp_plant1), 
                              function(i) MR3(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MR_mod3))

imp_plant_MR_mod4 <- list()
imp_plant_MR_mod4 <- mclapply(seq_along(df_imp_plant1), 
                              function(i) MR4(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MR_mod4))

imp_plant_MR_mod5 <- list()
imp_plant_MR_mod5 <- mclapply(seq_along(df_imp_plant1), 
                              function(i) MR5(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
...
imp_plant_MMA_pb1 <- mclapply(seq_along(df_imp_plant1), 
                              function(i) MMA_pb(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MMA_pb1))
```

```{r}
imp_plant_MR_pb1 <- list()
imp_plant_MR_pb1 <- mclapply(seq_along(df_imp_plant1), 
                             function(i) MR1_pb(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MR_pb1))

imp_plant_MR_pb3 <- list()
imp_plant_MR_pb3 <- mclapply(seq_along(df_imp_plant1), 
                             function(i) MR3_pb(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
summary(pool(imp_plant_MR_pb3))

imp_plant_MR_pb5 <- list()
imp_plant_MR_pb5 <- mclapply(seq_along(df_imp_plant1), 
                             function(i) MR5_pb(df_imp_plant1[[i]], VCV_mat_plant_imp[[i]], i), mc.cores = num_cores)
