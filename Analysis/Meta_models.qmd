...
for (i in seq_along(df_imp_coupe2)) {
  imp_coupe_MR_mod2[[i]] <- rma.mv(Effect_size ~ -1 + Method + Plot_size, V = VCV_mat_coupe_imp1[[i]], test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_coupe2[[i]], verbose = TRUE) }
...
for (i in seq_along(df_imp_coupe3)) {
  imp_coupe_MMA_pb1[[i]] <- rma.mv(Effect_size, V = VCV_mat_coupe_imp[[i]], mods = ~ 1 + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_coupe3[[i]], verbose = TRUE) }
summary(pool(imp_coupe_MMA_pb1))
```

```{r}
imp_coupe_MR_pb1 <- list()
for (i in seq_along(df_imp_coupe4)) {
  imp_coupe_MR_pb1[[i]] <- rma.mv(Effect_size, V = VCV_mat_coupe_imp1[[i]], mods = ~ Method + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_coupe4[[i]], verbose = TRUE) }
summary(pool(imp_coupe_MR_pb1))

imp_coupe_MR_pb3 <- list()
for (i in seq_along(df_imp_coupe3)) {
  imp_coupe_MR_pb1[[i]] <- rma.mv(Effect_size, V = VCV_mat_coupe_imp[[i]], mods = ~ Animal + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_coupe3[[i]], verbose = TRUE) }
summary(pool(imp_coupe_MR_pb3))

imp_coupe_MR_pb5 <- list()
for (i in seq_along(df_imp_coupe4)) {
  imp_coupe_MR_pb1[[i]] <- rma.mv(Effect_size, V = VCV_mat_coupe_imp1[[i]], mods = ~ Method * Months + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_coupe4[[i]], verbose = TRUE) }
...
for (i in seq_along(df_imp_lscape2)) {
  imp_lscape_MR_mod5[[i]] <- rma.mv(Effect_size ~ Method * Months + Plot_size, V = VCV_mat_lscape_imp1[[i]], test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_lscape2[[i]], verbose = TRUE) }
...
for (i in seq_along(df_imp_lscape3)) {
  imp_lscape_MMA_pb1[[i]] <- rma.mv(Effect_size, V = VCV_mat_lscape_imp[[i]], mods = ~ 1 + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_lscape3[[i]], verbose = TRUE) }
...
for (i in seq_along(df_imp_lscape3)) {
  imp_lscape_MR_pb1[[i]] <- rma.mv(Effect_size, V = VCV_mat_lscape_imp[[i]], mods = ~ Method + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_lscape3[[i]], verbose = TRUE) }
summary(pool(imp_lscape_MR_pb1))

imp_lscape_MR_pb3 <- list()
for (i in seq_along(df_imp_lscape3)) {
  imp_lscape_MR_pb3[[i]] <- rma.mv(Effect_size, V = VCV_mat_lscape_imp[[i]], mods = ~ Animal + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_lscape3[[i]], verbose = TRUE) }
summary(pool(imp_lscape_MR_pb3))

imp_lscape_MR_pb5 <- list()
for (i in seq_along(df_imp_lscape4)) {
  imp_lscape_MR_pb5[[i]] <- rma.mv(Effect_size, V = VCV_mat_lscape_imp1[[i]], mods = ~ Method * Months + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_lscape4[[i]], verbose = TRUE) }
