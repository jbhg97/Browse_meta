...
for (i in seq_along(df_imp_plant1)) {
  imp_plant_MR_mod5[[i]] <- rma.mv(Effect_size ~ Method * Months + Plot_size, V = VCV_mat_plant_imp[[i]], test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_plant1[[i]], verbose = TRUE) }
...
for (i in seq_along(df_imp_plant2)) {
  imp_plant_MR_pb3[[i]] <- rma.mv(Effect_size, V = VCV_mat_plant_imp[[i]], mods = ~ Animal + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_plant2[[i]], verbose = TRUE) }
summary(pool(imp_plant_MR_pb3))
imp_plant_MR_pb5 <- list()
for (i in seq_along(df_imp_plant2)) {
  imp_plant_MR_pb5[[i]] <- rma.mv(Effect_size, V = VCV_mat_plant_imp[[i]], mods = ~ Method * Months + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_imp_plant2[[i]], verbose = TRUE) }
...
imp_coupe_MR_mod3 <- lapply(seq_along(df_imp_coupe1), 
                              function(i) MR3(df_imp_coupe1[[i]], VCV_mat_coupe_imp[[i]], i))
summary(pool(imp_coupe_MR_mod3))
saveRDS(imp_coupe_MR_mod3, here("Results", "Models", "Coupe", "imp_coupe_MR3.rds"))
rm(imp_coupe_MR_mod3)
```

```{r}
imp_coupe_MR_mod4 <- list()
imp_coupe_MR_mod4 <- lapply(seq_along(df_imp_coupe1), 
                              function(i) MR4(df_imp_coupe1[[i]], VCV_mat_coupe_imp[[i]], i))
...
imp_coupe_MR_mod5 <- lapply(seq_along(df_imp_coupe2), 
                              function(i) MR5(df_imp_coupe2[[i]], VCV_mat_coupe_imp1[[i]], i))
summary(pool(imp_coupe_MR_mod5))
saveRDS(imp_coupe_MR_mod5, here("Results", "Models", "Coupe", "imp_coupe_MR5.rds"))
rm(imp_coupe_MR_mod5)
```
...
imp_coupe_MMA_pb1 <- lapply(seq_along(df_imp_coupe3), 
                              function(i) MMA(df_imp_coupe3[[i]], VCV_mat_coupe_imp[[i]], i))
...
imp_coupe_MR_pb1 <- lapply(seq_along(df_imp_coupe4), 
                             function(i) MMA(df_imp_coupe4[[i]], VCV_mat_coupe_imp1[[i]], i))
...
imp_coupe_MR_pb3 <- lapply(seq_along(df_imp_coupe3), 
                             function(i) MMA(df_imp_coupe3[[i]], VCV_mat_coupe_imp[[i]], i))
...
imp_coupe_MR_pb5 <- lapply(seq_along(df_imp_coupe4), 
                             function(i) MMA(df_imp_coupe4[[i]], VCV_mat_coupe_imp1[[i]], i))
...
imp_lscape_MMA_pb1 <- mclapply(seq_along(df_imp_lscape3), 
                               function(i) MMA(df_imp_lscape3[[i]], VCV_mat_lscape_imp[[i]], i), mc.cores = num_cores)
