...
imp_coupe_MMA_mod1 <- mclapply(seq_along(df_imp_coupe1), 
                               function(i) MMA(df_imp_coupe1[[i]], VCV_mat_coupe_imp[[i]], i), mc.cores = num_cores)
...
imp_coupe_MR_pb1 <- mclapply(seq_along(df_imp_coupe4), 
                             function(i) MMA(df_imp_coupe4[[i]], VCV_mat_coupe_imp1[[i]], i), mc.cores = num_cores)
