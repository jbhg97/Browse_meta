...
saveRDS(plant_MMA_pb1, "/homevol/jbhg97/Browse_meta/Results/Models/Plant/Plant_MMA_pb")
...
saveRDS(plant_MR_pb1, "/homevol/jbhg97/Browse_meta/Results/Models/Plant/Plant_MR1_pb")
saveRDS(plant_MR_pb3, "/homevol/jbhg97/Browse_meta/Results/Models/Plant/Plant_MR3_pb")
saveRDS(plant_MR_pb5, "/homevol/jbhg97/Browse_meta/Results/Models/Plant/Plant_MR5_pb")
```
...
coupe_MR_mod5_rob <- robust(coupe_MR_mod5, cluster = df_comp_coupe$Paper_ID)
...
```{r}
df_comp_coupe1 <- df_comp_coupe %>% mutate(Eff_SS = (4*(Con_N*Trt_N)) / (Con_N + Trt_N))
```

```{r}
funnel(df_comp_coupe1$Effect_size, df_comp_coupe1$Sampling_variance, ni = df_comp_coupe1$Eff_SS, yaxis="ni",
       ylab = "Effective sample size",
       xlab = "Effect size (SMD)") 
```
...
#centre the publication year
#calculate sqrt inverse effective sample size
df_comp_coupe2 <- df_comp_coupe1 %>% mutate(Year = Year - mean(Year),
                                            root_inv_ESS = sqrt((Con_N + Trt_N)/(Con_N*Trt_N)) )

```

```{r}
coupe_MMA_pb1 <- rma.mv(Effect_size, V = VCV_mat_coupe, mods = ~ 1 + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_coupe2)
summary(coupe_MMA_pb1)
```

```{r}
coupe_MR_pb1 <- rma.mv(Effect_size, V = VCV_mat_coupe, mods = ~ Method + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_coupe2)
summary(coupe_MR_pb1)

coupe_MR_pb3 <- rma.mv(Effect_size, V = VCV_mat_coupe, mods = ~ Animal + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_coupe2)
summary(coupe_MR_pb3)

coupe_MR_pb5 <- rma.mv(Effect_size, V = VCV_mat_coupe, mods = ~ Method * Months + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_coupe2)
...
saveRDS(coupe_MMA_pb1, "/homevol/jbhg97/Browse_meta/Results/Models/Coupe/coupe_MMA_pb")
...
saveRDS(coupe_MR_pb1, "/homevol/jbhg97/Browse_meta/Results/Models/Coupe/coupe_MR1_pb")
saveRDS(coupe_MR_pb3, "/homevol/jbhg97/Browse_meta/Results/Models/Coupe/coupe_MR3_pb")
saveRDS(coupe_MR_pb5, "/homevol/jbhg97/Browse_meta/Results/Models/Coupe/coupe_MR5_pb")
```
...
lscape_MR_mod5_rob <- robust(lscape_MR_mod5, cluster = df_comp_lscape$Paper_ID)
...
```{r}
df_comp_lscape1 <- df_comp_lscape %>% mutate(Eff_SS = (4*(Con_N*Trt_N)) / (Con_N + Trt_N))
```

```{r}
funnel(df_comp_lscape1$Effect_size, df_comp_lscape1$Sampling_variance, ni = df_comp_lscape1$Eff_SS, yaxis="ni",
       ylab = "Effective sample size",
       xlab = "Effect size (SMD)") 
```
...
#centre the publication year
#calculate sqrt inverse effective sample size
df_comp_lscape2 <- df_comp_lscape1 %>% mutate(Year = Year - mean(Year),
                                            root_inv_ESS = sqrt((Con_N + Trt_N)/(Con_N*Trt_N)) )

```

```{r}
lscape_MMA_pb1 <- rma.mv(Effect_size, V = VCV_mat_lscape, mods = ~ 1 + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_lscape2)
summary(lscape_MMA_pb1)
```

```{r}
lscape_MR_pb1 <- rma.mv(Effect_size, V = VCV_mat_lscape, mods = ~ Method + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_lscape2)
summary(lscape_MR_pb1)

lscape_MR_pb3 <- rma.mv(Effect_size, V = VCV_mat_lscape, mods = ~ Animal + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_lscape2)
summary(lscape_MR_pb3)

lscape_MR_pb5 <- rma.mv(Effect_size, V = VCV_mat_lscape, mods = ~ Method * Months + Plot_size + Year + root_inv_ESS, test = "t", dfs = "contain", random = list(~1|Paper_ID, ~1|Repeat_measures, ~1|Plant_genus, ~1|OLRE), data = df_comp_lscape2)
...
saveRDS(lscape_MMA_pb1, "/homevol/jbhg97/Browse_meta/Results/Models/Landscape/lscape_MMA_pb")
...
saveRDS(lscape_MR_pb1, "/homevol/jbhg97/Browse_meta/Results/Models/Landscape/lscape_MR1_pb")
saveRDS(lscape_MR_pb3, "/homevol/jbhg97/Browse_meta/Results/Models/Landscape/lscape_MR3_pb")
saveRDS(lscape_MR_pb5, "/homevol/jbhg97/Browse_meta/Results/Models/Landscape/lscape_MR5_pb")
```
