...
```{r}
pub_yr <- read_excel("/homevol/jbhg97/Browse_meta/Data processing/Lit review data.xlsx", sheet = "Complete list")
...
```{r}
write_xlsx(df_SMD_sdtrans1, "/homevol/jbhg97/Browse_meta/Data processing/SMD_compcase_raw and transform.xlsx")
```
...
```{r}
write_xlsx(df_comp_SMD2, "/homevol/jbhg97/Browse_meta/Data processing/SMD_compcase_es.xlsx")
```
...
```{r}
write_xlsx(df_comp_lo2, "/homevol/jbhg97/Browse_meta/Data processing/LO_compcase_es.xlsx")
```
